...
version 1.0.0 (2026-07-09) — 正本。実装とズレたらコードを直す。仕様変更は version bump + changelog。
...
- **R2**: システムは入力ステレオを K-weighting（正本の係数）した 400ms ブロック平均パワーから、BS.1770 二段ゲート（絶対 -70 LUFS → 相対 -10 LU）で integrated LUFS を算出し、momentary LUFS とともに表示する
